 ...
 * Author: 3urobeat
 * 
 * Last Modified: 02.03.2022 17:37:10
 ...
 */
module.exports.getAccountOrder = (allAccounts, accountsNeeded, numberOfComments, requesterSteamID, recieverSteamID, lang, respond) => {
    var accsToAdd = [];
